...
with tab_model:
    ...
    st.markdown(
        ...
        **MODEL & DATA OVERVIEW**  
        ...
        The model is designed for research and demonstration use, supporting both clinical interpretation and patient understanding of cardiovascular risk factors.
...
with tab_faq:
    ...
    st.markdown(
        ...
        **Is this a clinical decision support tool?**  
        No. This application is intended for research and demonstration purposes only. It must not be used as a standalone diagnostic or treatment decision system.
